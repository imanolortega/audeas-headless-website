    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <NavigationMenu className="hidden md:flex">
            <NavigationMenuList>
              {items.map(({ ID, url, slug, title, type, children }) => {
                ...
                const getUrl = (type: string, url: string, slug: string): string => {
                            ...
                            {children.map((child: any) => (
                              <li key={child.ID}>
                                <NavigationMenuLink asChild>
                                  <Link
                                    href={getUrl(child.type, child.url, child.slug)}
          ...
          <Button asChild className="hidden sm:flex bg-audeas hover:bg-audeas/95 text-base">
